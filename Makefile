...
SourceMapping.o: SourceMapping.cpp SourceMapping.h
	$(CXX) $(CLANG_CFL) -c -fPIC SourceMapping.cpp

dump_pass.o: dump_pass.cpp
	$(CXX) $(CLANG_CFL) -c -fPIC dump_pass.cpp

dump_pass.so: dump_pass.o RangeAnalysis.o SourceMapping.o
	-$(CXX) $(CLANG_CFL) -fno-rtti -fPIC -std=$(LLVM_STDCXX) -shared dump_pass.o RangeAnalysis.o SourceMapping.o -o $@ $(CLANG_LFL)

.NOTPARALLEL: clean

clean:
	rm -f dump_pass.so dump_pass.o RangeAnalysis.o SourceMapping.o dump_rt.o dump_rt.a
